...
struct hash<se::SeModel::Vertex> {
    size_t operator()(se::SeModel::Vertex const& vertex) const {
        size_t seed = 0;
...
namespace se {
SeModel::SeModel(SeDevice &device, const Builder& builder) : seDevice{device} {
...
void SeModel::createIndexBuffer(const std::vector<uint32_t>& indices) {
